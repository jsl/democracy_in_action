Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "License.txt", "Manifest.txt", "PostInstall.txt", "README.txt", "Rakefile", "config/hoe.rb", "config/requirements.rb", "lib/democracy_in_action.rb", "lib/democracy_in_action/api.rb", "lib/democracy_in_action/config_rexml.rb", "lib/democracy_in_action/desc_parse.rb", "lib/democracy_in_action/util.rb", "lib/democracy_in_action/version.rb", "lib/democracy_in_action/xml_parse.rb", "script/console", "script/destroy", "script/generate", "script/txt2html", "setup.rb", "spec/democracy_in_action_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "tasks/deployment.rake", "tasks/environment.rake", "tasks/rspec.rake", "tasks/website.rake", "website/index.html", "website/index.txt", "website/javascripts/rounded_corners_lite.inc.js", "website/stylesheets/screen.css", "website/template.html.erb"]
  s.has_rdoc = true
